...
extension Property {
    public static func payloadFormatIndicator(_ value: Byte) -> Property {
        return self.init(identifier: .payloadFormatIndicator, value: .byte(value))
    }

    public static func messageExpiryInterval(_ value: UInt32) -> Property {
        return self.init(identifier: .messageExpiryInterval, value: .fourByteInt(value))
    }

    public static func contentType(_ value: String) -> Property {
        return self.init(identifier: .contentType, value: .utf8String(value))
    }

    public static func responseTopic(_ value: String) -> Property {
        return self.init(identifier: .responseTopic, value: .utf8String(value))
    }

    public static func correlationData(_ value: Bytes) -> Property {
        return self.init(identifier: .correlationData, value: .binaryData(value))
    }

    public static func subscriptionIdentifier(_ value: UInt) -> Property {
        return self.init(identifier: .subscriptionIdentifier, value: .variableByteInt(value))
    }

    public static func sessionExpiryInterval(_ value: UInt32) -> Property {
        return self.init(identifier: .sessionExpiryInterval, value: .fourByteInt(value))
    }

    public static func assignedClientIdentifier(_ value: String) -> Property {
        return self.init(identifier: .assignedClientIdentifier, value: .utf8String(value))
    }

    public static func serverKeepalive(_ value: UInt16) -> Property {
        return self.init(identifier: .serverKeepalive, value: .twoByteInt(value))
    }

    public static func authenticationMethod(_ value: String) -> Property {
        return self.init(identifier: .authenticationMethod, value: .utf8String(value))
    }

    public static func authenticationData(_ value: Bytes) -> Property {
        return self.init(identifier: .authenticationData, value: .binaryData(value))
    }

    public static func requestProblemInformation(_ value: Byte) -> Property {
        return self.init(identifier: .requestProblemInformation, value: .byte(value))
    }

    public static func willDelayInterval(_ value: UInt32) -> Property {
        return self.init(identifier: .willDelayInterval, value: .fourByteInt(value))
    }

    public static func requestResponseInformation(_ value: Byte) -> Property {
        return self.init(identifier: .requestResponseInformation, value: .byte(value))
    }

    public static func responseInformation(_ value: String) -> Property {
        return self.init(identifier: .responseInformation, value: .utf8String(value))
    }

    public static func serverReference(_ value: String) -> Property {
        return self.init(identifier: .serverReference, value: .utf8String(value))
    }

    public static func reasonString(_ value: String) -> Property {
        return self.init(identifier: .reasonString, value: .utf8String(value))
    }

    public static func receiveMaximum(_ value: UInt16) -> Property {
        return self.init(identifier: .receiveMaximum, value: .twoByteInt(value))
    }

    public static func topicAliasMaximum(_ value: UInt16) -> Property {
        return self.init(identifier: .topicAliasMaximum, value: .twoByteInt(value))
    }

    public static func topicAlias(_ value: UInt16) -> Property {
        return self.init(identifier: .topicAlias, value: .twoByteInt(value))
    }

    public static func maximumQoS(_ value: Byte) -> Property {
        return self.init(identifier: .maximumQoS, value: .byte(value))
    }

    public static func retainAvailable(_ value: Byte) -> Property {
        return self.init(identifier: .retainAvailable, value: .byte(value))
    }

    public static func userProperty(_ value1: String, _ value2: String) -> Property {
        return self.init(identifier: .userProperty, value: .utf8StringPair(value1, value2))
    }

    public static func maximumPacketSize(_ value: UInt32) -> Property {
        return self.init(identifier: .maximumPacketSize, value: .fourByteInt(value))
    }

    public static func wildcardSubscriptionAvailable(_ value: Byte) -> Property {
        return self.init(identifier: .wildcardSubscriptionAvailable, value: .byte(value))
    }

    public static func subscriptionIdentifierAvailable(_ value: Byte) -> Property {
        return self.init(identifier: .subscriptionIdentifierAvailable, value: .byte(value))
    }

    public static func sharedSubscriptionAvailable(_ value: Byte) -> Property {
        return self.init(identifier: .sharedSubscriptionAvailable, value: .byte(value))
    }
}
...
public func decodeUTF8String(
    ...
    guard let length = buffer.readInteger(endianness: .big, as: UInt16.self) else {
        throw MQTTError.protocolViolation(
            .malformedPacket(
                reason: .decodeError(
                    "Unable to read two byte integer at index: \(buffer.readerIndex), from buffer: \(buffer.debugDescription)"
                )))
    }
    ...
    guard let data = buffer.readBytes(length: Int(length)) else {
        throw MQTTError.protocolViolation(
            .malformedPacket(
                reason: .decodeError(
                    "Unable to read byte sequence of length: \(length) at index: \(buffer.readerIndex), from buffer: \(buffer.debugDescription)"
                )))
    }
...
extension Property {
    public static func decode(
        id: PropertyIdentifier, from buffer: inout ByteBuffer, bytesRead: inout Int
    ) throws -> Property {
        switch id {
        case .payloadFormatIndicator:
            guard let value = buffer.readInteger(as: Byte.self) else {
                throw MQTTError.protocolViolation(
                    .malformedPacket(
                        reason: .decodeError(
                            "Unable to read byte at index: \(buffer.readerIndex), from buffer: \(buffer.debugDescription)"
                        )))
            }
            bytesRead += 1
        ...
        case .messageExpiryInterval:
            guard let value = buffer.readInteger(endianness: .big, as: UInt32.self) else {
                throw MQTTError.protocolViolation(
                    .malformedPacket(
                        reason: .decodeError(
                            "Unable to read four byte integer at index: \(buffer.readerIndex), from buffer: \(buffer.debugDescription)"
                        )))
            }
            bytesRead += 4
...
public func decodeProperties(from bytes: Bytes, length: UInt) throws -> [Property] {
